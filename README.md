...
> **v0.2.0 is available.** [Download the latest release](https://github.com/GNP1-dev/PoolTerminal/releases/latest) · Linux (AppImage / .deb). Active development - star to follow progress.
>
...
> _Last updated: 30 July 2026_ <!-- readme-beta-v3 -->
...
```bash
./PoolTerminal_0.2.0_amd64.AppImage --appimage-extract-and-run
```
