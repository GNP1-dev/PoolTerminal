...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cache::cache_put_delegator_stake,
            cache::cache_get_delegator_stake,
            cache::cache_delegator_max_epoch,
            cache::cache_put_loyalty,
            cache::cache_get_loyalty,
            ...
            cache::cache_clear_notif_events,
