...
const NODE_FEATURES = [
  ...
  { label: 'Node logs (Logs tab)', desc: 'Read-only journalctl queries against your node’s systemd units - the BP unit configured in the Logs tab, plus its CNCLI leaderlog and validate services.', note: 'Read-only, run at low CPU/IO priority. Nothing is written to the node.' },   /*generic-unit-v106*/
